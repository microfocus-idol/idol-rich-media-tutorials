...
2. Under the *Get Software* tab, select and download `IDOLServer_12.6.0_WINDOWS_X86_64.exe` or `IDOLServer_12.6.0_LINUX_X86_64.exe` depending on your system.
...
```bsh
chmod +x IDOLServer_12.6.0_LINUX_X86_64.exe
./IDOLServer_12.6.0_LINUX_X86_64.exe
```
