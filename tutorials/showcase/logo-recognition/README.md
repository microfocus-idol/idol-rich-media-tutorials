...
For a more detailed introduction to Object Recognition, see the [admin guide](https://www.microfocus.com/documentation/idol/IDOL_12_6/MediaServer_12.6_Documentation/Guides/html/English/index.html#Operations/Analyze/ObjectRecognition_Introduction.htm).
...
For full details on the options available for ingesting video (and other) sources, please read the [reference guide](https://www.microfocus.com/documentation/idol/IDOL_12_6/MediaServer_12.6_Documentation/Help/index.html#Configuration/Ingest/_Ingest.htm).
...
We have also specified some parameters that affect how the analytic runs.  For full details on these and other available options, please read the [reference guide](https://www.microfocus.com/documentation/idol/IDOL_12_6/MediaServer_12.6_Documentation/Help/index.html#Configuration/Analysis/Object/_Object.htm).
...
*N.B.* In production it is recommended to reference a script file, e.g. using the logo filter:
